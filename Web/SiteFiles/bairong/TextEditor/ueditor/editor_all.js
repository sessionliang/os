...
(function () {
    ...
    var Editor = UE.Editor = function ( options ) {
        ...
        me.setOpt( {
            ...
            initialFrameHeight:me.options.minFrameHeight||320,//兼容老版本设置项
            minFrameWidth:800,
            minFrameHeight:220,
...
//            }
         ...
         * @grammar editor.disable(except)  //例外的命令，也即即使设置了disable，此处设置的命令仍然可以执行
         * @example
...
//ui跟编辑器的适配層
//那个按钮弹出是dialog，是下拉筐等都是在这个js中设置
//自己写的ui也要在这里设置，放到baidu.editor.ui下边，当编辑器实例化的时候会根据editor_config中的toolbars找到相应的进行实例化
(function () {
    var utils = baidu.editor.utils;
