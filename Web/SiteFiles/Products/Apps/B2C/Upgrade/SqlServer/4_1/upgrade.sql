 ...
 * 3.6.x 升级 4.1
 */
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Brand') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_BrandContent') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Cart') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Configuration') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Consignee') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Filter') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_FilterItem') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Follow') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Goods') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Invoice') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Location') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Order') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_OrderItem') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Payment') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Photo') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Promotion') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Request') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_RequestAnswer') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Shipment') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Spec') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_SpecCombo') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_SpecItem') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_UserSetting') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
--订单评价
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_OrderItemComment') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
--购买咨询
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_Consultation') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
--浏览历史
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_History') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
--订单退货
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('b2c_OrderItemReturn') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE PARENT_OBJ = OBJECT_ID('b2c_FilterItem') AND NAME = 'FK_b2c_Filter_FilterItem' AND XTYPE = 'F')
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE PARENT_OBJ = OBJECT_ID('b2c_OrderItem') AND NAME = 'FK_b2c_Order_OrderItem' AND XTYPE = 'F')
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE PARENT_OBJ = OBJECT_ID('b2c_RequestAnswer') AND NAME = 'FK_b2c_Request_Answer' AND XTYPE = 'F')
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE PARENT_OBJ = OBJECT_ID('b2c_OrderItemComment') AND NAME = 'FK_b2c_OrderItem_OrderItemComment' AND XTYPE = 'F')
...
--订单扩展字段（存放校验log，交易流水号）
IF NOT EXISTS(SELECT * FROM SYSCOLUMNS WHERE ID = OBJECT_ID('b2c_Order') AND NAME = 'Extended')
ALTER TABLE b2c_Order ADD
	Extended    ntext DEFAULT '' NOT NULL
GO
