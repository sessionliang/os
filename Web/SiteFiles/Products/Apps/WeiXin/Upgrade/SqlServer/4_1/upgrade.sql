...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Account') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Album') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_AlbumContent') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Appointment') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_AppointmentContent') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_AppointmentItem') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Conference') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_ConferenceContent') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Count') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Coupon') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_CouponAct') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSCOLUMNS WHERE ID = OBJECT_ID('wx_CouponAct') AND NAME = 'AwardCode')
ALTER TABLE wx_CouponAct
   ADD  AwardCode    nvarchar(50)     DEFAULT '' NOT NULL
GO


IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_CouponSN') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Keyword') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_KeywordGroup') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_KeywordMatch') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_KeywordResource') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Lottery') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSCOLUMNS WHERE ID = OBJECT_ID('wx_Lottery') AND NAME = 'AwardCode')
ALTER TABLE wx_Lottery
   ADD  AwardCode    nvarchar(50)     DEFAULT '' NOT NULL
GO


IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_LotteryAward') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_LotteryLog') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_LotteryWinner') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Map') AND OBJECTPROPERTY(ID,'IsTable') = 1)
CREATE TABLE wx_Map(
    ID                     int              IDENTITY(1,1),
    PublishmentSystemID    int              DEFAULT 0 NOT NULL,
    KeywordID              int              DEFAULT 0 NOT NULL,
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Menu') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Message') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_MessageContent') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Search') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_SearchNavigation') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Store') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_StoreCategory') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_StoreItem') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_View360') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Vote') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_VoteItem') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_VoteLog') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_WebMenu') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_Wifi') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_WifiNode') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_CardCashLog') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_ConfigExtend') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_CardSignLog') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYSINDEXES WHERE ID = OBJECT_ID('wx_KeywordMatch') AND NAME = 'IX_wx_KeywordMatch_K')
CREATE INDEX IX_wx_KeywordMatch_K ON wx_KeywordMatch(Keyword)
GO

IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_CouponSN') AND NAME = 'FK_wx_Coupon_SN' AND XTYPE = 'FK')
ALTER TABLE wx_CouponSN ADD CONSTRAINT FK_wx_Coupon_SN 
    FOREIGN KEY (CouponID)
    REFERENCES wx_Coupon(ID) ON DELETE CASCADE ON UPDATE CASCADE
GO

IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_KeywordMatch') AND NAME = 'FK_wx_Keyword_KeywordMatch' AND XTYPE = 'FK')
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_KeywordResource') AND NAME = 'FK_wx_Keyword_KeywordResource' AND XTYPE = 'FK')
ALTER TABLE wx_KeywordResource ADD CONSTRAINT FK_wx_Keyword_KeywordResource 
    FOREIGN KEY (KeywordID)
    REFERENCES wx_Keyword(KeywordID) ON DELETE CASCADE ON UPDATE CASCADE
GO

IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_LotteryLog') AND NAME = 'FK_wx_Lottery_Log' AND XTYPE = 'FK')
...
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('wx_LotteryWinner') AND NAME = 'FK_wx_LotteryAward_Winner' AND XTYPE = 'FK')
