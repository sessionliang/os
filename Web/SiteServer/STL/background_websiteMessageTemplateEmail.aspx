<%@ Page Language="C#" ValidateRequest="false" Inherits="SiteServer.STL.BackgroundPages.BackgroundWebsiteMessageTemplateEmail" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="popover popover-static">
            <h3 class="popover-title">邮件回复模板</h3>
            <div class="popover-content">
                ...
                <table class="table noborder table-hover">
                    ...
                    <asp:PlaceHolder ID="phTemplate" runat="server">
                        ...
                        <tr>
                            <td width="155">
                                <bairong:Help HelpText="邮件标题" Text="邮件标题：" runat="server"></bairong:Help>
                            </td>
                            <td>
                                <asp:TextBox Width="98%" ID="Title" runat="server" Rows="10" Wrap="false" /></td>
                        </tr>
                        <tr>
                            <td width="155">
                                <bairong:Help HelpText="邮件内容" Text="邮件内容：" runat="server"></bairong:Help>
                            </td>
                            <td>
