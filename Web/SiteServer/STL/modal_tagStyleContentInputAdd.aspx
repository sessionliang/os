<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.Modal.TagStyleContentInputAdd" Trace="false"%>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table table-noborder table-hover">
    ...
    <tr>
      <td><bairong:help HelpText="设置提交时使用的内容字段" Text="提交时使用的内容字段：" runat="server" ></bairong:help></td>
      <td><asp:DropDownList ID="ChannelID" runat="server"></asp:DropDownList></td>
    </tr>
    <tr>
      <td><bairong:help HelpText="设置提交内容是否需要审核" Text="是否需要审核：" runat="server" ></bairong:help></td>
      <td><asp:RadioButtonList ID="IsChecked" RepeatDirection="Horizontal" class="noborder" runat="server">
    ...
    <tr>
      <td><bairong:help HelpText="设置是否显示提交栏目" Text="显示提交栏目：" runat="server" ></bairong:help></td>
    ...
    <tr>
      <td><bairong:help HelpText="设置表单提交成功后是否隐藏" Text="提交成功后是否隐藏：" runat="server" ></bairong:help></td>
      <td><asp:RadioButtonList ID="IsSuccessHide" RepeatDirection="Horizontal" class="noborder" runat="server">
          <asp:ListItem Text="隐藏" Value="True" Selected="true"></asp:ListItem>
          <asp:ListItem Text="不隐藏" Value="False"></asp:ListItem>
        </asp:RadioButtonList></td>
    </tr>
    <tr>
      <td><bairong:help HelpText="设置表单提交成功后是否刷新页面" Text="提交成功后是否刷新页面：" runat="server" ></bairong:help></td>
      <td><asp:RadioButtonList ID="IsSuccessReload" RepeatDirection="Horizontal" class="noborder" runat="server">
          <asp:ListItem Text="刷新" Value="True"></asp:ListItem>
          <asp:ListItem Text="不刷新" Value="False" Selected="true"></asp:ListItem>
        </asp:RadioButtonList></td>
    </tr>
    <tr>
      <td><bairong:help HelpText="设置是否启用Ctrl+Enter快速提交" Text="启用Ctrl+Enter快速提交：" runat="server" ></bairong:help></td>
      <td colspan="3"><asp:RadioButtonList ID="IsCtrlEnter" RepeatDirection="Horizontal" class="noborder" runat="server">
