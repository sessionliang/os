<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.ConsoleUserCenterReplace" %>
  ...
  <div class="popover popover-static">
    ...
    <div class="popover-content">
      ...
      <asp:dataGrid id="dgContents" showHeader="true" AutoGenerateColumns="false" DataKeyField="Name" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" runat="server">
        <Columns>
          ...
          <asp:BoundColumn HeaderText="模板文件夹" DataField="Name" >
            <ItemStyle Width="100" cssClass="center" />
          </asp:BoundColumn>
          <asp:TemplateColumn HeaderText="模板介绍">
    ...
    <asp:PlaceHolder id="CreateSiteParameters" runat="server" Visible="false">
      ...
      <table class="table table-noborder table-hover">
        <tr>
          <td width="160">清除用户中心栏目及内容：</td>
          <td>
            <asp:RadioButtonList ID="IsDeleteChannels" runat="server" RepeatDirection="Horizontal" class="noborder">
              <asp:ListItem Text="清除用户中心栏目及内容" Value="True" Selected="true"></asp:ListItem>
              <asp:ListItem Text="保留用户中心栏目及内容" Value="False" ></asp:ListItem>
            </asp:RadioButtonList>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <asp:RadioButtonList ID="IsDeleteTemplates" runat="server" RepeatDirection="Horizontal" class="noborder">
              <asp:ListItem Text="清除用户中心显示模板" Value="True" Selected="true"></asp:ListItem>
              <asp:ListItem Text="保留用户中心显示模板" Value="False"></asp:ListItem>
            </asp:RadioButtonList>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <asp:RadioButtonList ID="IsDeleteFiles" runat="server" RepeatDirection="Horizontal" class="noborder">
              <asp:ListItem Text="清除用户中心文件" Value="True" Selected="true"></asp:ListItem>
              <asp:ListItem Text="保留用户中心文件" Value="False"></asp:ListItem>
            </asp:RadioButtonList>
          </td>
        </tr>
        <tr>
