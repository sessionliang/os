<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.Modal.StlTemplate.StlElementAudio" validateRequest="false" %>
  ...
  <div class="tab-content">
    <div class="tab-pane active" id="datasource">
      ...
      <table class="table table-noborder" ng-controller="SettingsController">
        <tr>
          <td width="120"><span rel="tooltip" data-original-title="playUrl 属性">音频地址：</span></td>
          <td colspan="3">
