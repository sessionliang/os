<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.BackgroundTagStyleContentInput" %>
...
<form class="form-inline" runat="server">
  ...
  <asp:dataGrid id="dgContents" showHeader="true" AutoGenerateColumns="false" DataKeyField="StyleID" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" gridlines="none" runat="server">
    <Columns>
      ...
      <asp:TemplateColumn>
        <ItemTemplate> <a href="background_tagStyleContentInput.aspx?Delete=True&PublishmentSystemID=<%=base.PublishmentSystemID%>&StyleID=<%# DataBinder.Eval(Container.DataItem,"StyleID")%>" onClick="javascript:return confirm('此操作将删除内容提交样式“<%# DataBinder.Eval(Container.DataItem,"StyleName")%>”，确认吗？');">删除</a> </ItemTemplate>
        <ItemStyle Width="50" cssClass="center" />
      </asp:TemplateColumn>
    </Columns>
  </asp:dataGrid>
