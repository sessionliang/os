<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.STL.BackgroundPages.BackgroundTemplateJsAdd" %>
      ...
      <table class="table noborder">
        <tr>
          <td class="center">
            ...
            <input type=button class="btn" onClick="location.href='background_templateJs.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>';" value="返 回" />
          </td>
        </tr>
      </table>
