<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.ConsolePublishmentSystemAdd" %>
    ...
    <div class="popover-content">
      ...
      <table class="table table-hover table-noborder">
            ...
            <tr>
              ...
              <td>
                ...
                <asp:RequiredFieldValidator
                  ...
                  Display="Dynamic"
                  runat="server"/>
                <asp:RegularExpressionValidator runat="server" ControlToValidate="PublishmentSystemDir" ValidationExpression="[a-zA-Z0-9_]+" ErrorMessage=" 只允许包含字母、数字以及下划线" Display="Dynamic" />
                <br>
          ...
          <tr id="RowIsUserSiteTemplateAuxiliaryTables" runat="server">
            ...
            <td>
              <asp:RadioButtonList ID="IsUserSiteTemplateAuxiliaryTables" AutoPostBack="true" OnSelectedIndexChanged="IsUserSiteTemplateAuxiliaryTables_SelectedIndexChanged" RepeatDirection="Horizontal" class="noborder" runat="server">
                <asp:ListItem Text="使用应用模板中的辅助表" Value="True"></asp:ListItem>
          ...
          <asp:PlaceHolder ID="phAuxiliaryTable" runat="server" Visible="false">
            ...
            <asp:PlaceHolder id="phB2CTables" visible="false" runat="server">
              <tr>
                <td>商品辅助表：</td>
                <td>
                  <asp:DropDownList ID="AuxiliaryTableForGoods" runat="server" > </asp:DropDownList>
                  <asp:RequiredFieldValidator
              ...
              <tr>
                <td>品牌辅助表：</td>
                <td>
                  <asp:DropDownList ID="AuxiliaryTableForBrand" runat="server" > </asp:DropDownList>
                  <asp:RequiredFieldValidator
