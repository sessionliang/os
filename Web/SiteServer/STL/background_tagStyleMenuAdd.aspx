<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.BackgroundTagStyleMenuAdd" %>
      ...
      <table class="table noborder table-hover">
        ...
        <tr>
          ...
          <td colspan="2"><asp:TextBox Columns="35" MaxLength="200" id="ChildMenuIcon" runat="server" />
            <asp:RegularExpressionValidator runat="server" ControlToValidate="MenuLiteBgColor"
                                      ValidationExpression="[^']+" errorMessage=" *" foreColor="red" display="Dynamic" />
            <%--                                <a href="javascript:OpenPictureSelect('<%=base.PublishmentSystemID%>
      ...
      <table class="table noborder">
        <tr>
          <td class="center">
            ...
            <input type=button class="btn" onClick="location.href='background_tagStyleMenu.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>';" value="返 回" />
          </td>
        </tr>
      </table>
