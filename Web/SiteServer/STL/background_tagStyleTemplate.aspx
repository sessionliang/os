<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.STL.BackgroundPages.BackgroundTagStyleTemplate" %>
        ...
        <asp:PlaceHolder ID="phTemplate" runat="server">
          ...
          <tr>
            ...
            <td><asp:TextBox Width="100%" Height="330" TextMode="MultiLine" ID="tbContent" runat="server" Wrap="false" />
              <asp:RequiredFieldValidator ControlToValidate="tbContent" ErrorMessage="模板内容必须填写，可以点击“生成默认模板”生成" Display="Dynamic" runat="server" /></td>
          </tr>
          ...
          <tr>
            ...
            <td><asp:TextBox Width="100%" Height="260" TextMode="MultiLine" ID="tbSuccess" runat="server" Wrap="false" />
              <asp:RequiredFieldValidator ControlToValidate="tbSuccess" ErrorMessage="模板内容必须填写，可以点击“生成默认模板”生成" Display="Dynamic" runat="server" /></td>
          </tr>
          </asp:PlaceHolder>
          ...
          <tr>
            ...
            <td><asp:TextBox Width="100%" Height="260" TextMode="MultiLine" ID="tbFailure" runat="server" Wrap="false" />
              <asp:RequiredFieldValidator ControlToValidate="tbFailure" ErrorMessage="模板内容必须填写，可以点击“生成默认模板”生成" Display="Dynamic" runat="server" /></td>
          </tr>
          </asp:PlaceHolder>
