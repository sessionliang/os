<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.BackgroundTemplateAdd" validateRequest="false" %>
      ...
      <table class="table noborder table-hover">
        ...
        <tr>
          ...
          <td colspan="3">
            ...
            <asp:RegularExpressionValidator ControlToValidate="RelatedFileName" ValidationExpression="(^T_[^'\.]+)|([^'\.]+[\\/]+T_[^'\.]+)" ErrorMessage="必须以T_开头，并且不能有文件扩展名" Display="Dynamic" runat="server"/>
        ...
        <tr id="CreatedFileFullNameRow" runat="server">
          ...
          <td colspan="3">
            ...
            <asp:RegularExpressionValidator ControlToValidate="CreatedFileFullName" ValidationExpression="[^'\.]+" ErrorMessage="不能有文件扩展名<br>" Display="Dynamic" runat="server"/>
      ...
      <table class="table noborder">
        <tr>
          <td class="center">
            ...
            <input type="button" class="btn" onClick="location.href='background_template.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>&templateType=<%=Request.QueryString["templateType"]%>';" value="返 回" />
          </td>
        </tr>
      </table>
