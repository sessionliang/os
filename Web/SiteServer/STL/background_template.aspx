<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.BackgroundTemplate" %>
  ...
  <div class="well well-small">
    <table class="table table-noborder">
      <tr>
        <td>
          模板类型：
          <asp:DropDownList ID="ddlTemplateType" class="input-medium" runat="server"></asp:DropDownList>
          模板名称/文件名：
