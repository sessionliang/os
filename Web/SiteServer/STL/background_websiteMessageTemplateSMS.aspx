<%@ Page Language="C#" ValidateRequest="false" Inherits="SiteServer.STL.BackgroundPages.BackgroundWebsiteMessageTemplateSMS" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="popover popover-static">
            <h3 class="popover-title">短信回复模板</h3>
            <div class="popover-content">
                ...
                <table class="table noborder table-hover">
                    ...
                    <asp:PlaceHolder ID="phTemplate" runat="server">
                        ...
                        <tr>
                            <td width="155">
                                <bairong:Help HelpText="短信内容" Text="短信内容：" runat="server"></bairong:Help>
                            </td>
                            <td>
