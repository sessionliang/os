<%@ Page Language="C#" ValidateRequest="false" Inherits="SiteServer.STL.BackgroundPages.BackgroundSubscribeTemplateSubmit" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="popover popover-static">
            <h3 class="popover-title">信息订阅模板</h3>
            <div class="popover-content">

                <table class="table noborder table-hover">
                    <tr style="display:none;">
                        <td width="155">
                            <bairong:Help HelpText="信息订阅" Text="信息订阅：" runat="server"></bairong:Help>
                        </td>
                        <td>
