<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.Modal.TagStyleGovPublicApplyAdd" Trace="false"%>
  ...
  <table class="table table-noborder table-hover">
    ...
    <asp:PlaceHolder ID="phMail" Visible="false" runat="server">
      ...
      <tr>
        ...
        <td><asp:TextBox Columns="35" MaxLength="50" id="MailTitleFormat" Text="提醒（来自依申请公开）" runat="server" />
