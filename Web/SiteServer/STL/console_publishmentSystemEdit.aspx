<%@ Page Language="C#" Inherits="SiteServer.STL.BackgroundPages.ConsolePublishmentSystemEdit" %>
        ...
        <tr id="PublishmentSystemDirRow" runat="server">
          ...
          <td>
            ...
            <asp:RegularExpressionValidator runat="server" ControlToValidate="PublishmentSystemDir"
              ValidationExpression="[a-zA-Z0-9_]+" ErrorMessage=" 只允许包含字母、数字以及下划线" Display="Dynamic" />
            <br>
      ...
      <table class="table noborder">
        <tr>
          <td class="center">
            ...
            <input type="button" class="btn" value="返 回" onClick="javascript:location.href='console_publishmentSystem.aspx';" />
          </td>
        </tr>
      </table>
