<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.STL.BackgroundPages.BackgroundTemplateCssAdd" %>
      ...
      <table class="table noborder">
        <tr>
          <td class="center">
            ...
            <input type=button class="btn" onClick="location.href='background_templateCss.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>';" value="返 回" />
          </td>
        </tr>
      </table>
