        ...
        <div class="popover popover-static">
            ...
            <div class="popover-content">
                ...
                <table class="table noborder table-hover">
                    ...
                    <tr id="WaterMarkQtyRow" runat="server">
                        <td width="160">
                            <bairong:Help HelpText="取值范围10%--100% (100%质量最高). " Text="水印质量：" runat="server"></bairong:Help>
                        </td>
                        <td>
                            <asp:DropDownList ID="WaterMarkQty" runat="server"></asp:DropDownList></td>
                    </tr>
