<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.Modal.TextEditorInsertAudio" %>
...
<bairong:alerts runat="server" text="请选择插入音频的方式"></bairong:alerts>
  ...
  $(document).ready(function(){
    new AjaxUpload('uploadFile', {
     action: 'modal_textEditorInsertAudio.aspx?upload=true&PublishmentSystemID=<%=base.PublishmentSystemID%>',
     name: "filedata",
     data: {},
