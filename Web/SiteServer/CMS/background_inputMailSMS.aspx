        ...
        <tr>
          <td class="center">
           ...
           <!-- <input type=button class="btn" onClick="location.href='background_input.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>';" value="返 回" />-->
            <input type=button class="btn" onClick="location.href='background_inputMainContent.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>&ItemID=<%=GetItemID()%> ';" value="返 回" />
          </td>
        </tr>
      </table>
