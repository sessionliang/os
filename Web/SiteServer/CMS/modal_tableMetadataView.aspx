...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table table-bordered table-striped">
    <asp:PlaceHolder ID="phAttribute" runat="server">
      ...
      <tr>
        <td width="140"><bairong:help HelpText="此字段是否允许为空，如果不允许为空，建议添加数据库默认值。" Text="是否允许为空：" runat="server" ></bairong:help></td>
        <td><asp:Label id="CanBeNull" runat="server" /></td>
      </tr>
      <tr>
        <td width="140"><bairong:help HelpText="此字段的默认值" Text="数据库默认值：" runat="server" ></bairong:help></td>
        <td><asp:Label id="DBDefaultValue" runat="server" /></td>
      </tr>
      <tr>
