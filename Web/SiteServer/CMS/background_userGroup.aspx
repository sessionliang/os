<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundUserGroup" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    ...
    <div class="popover-content">
      ...
      <asp:dataGrid id="MyDataGrid1" showHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" runat="server">
        <Columns>
  ...
  <div class="popover popover-static">
    ...
    <div class="popover-content">
      ...
      <asp:dataGrid id="MyDataGrid2" showHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" runat="server">
        <Columns>
        <asp:TemplateColumn HeaderText="会员组名称">
          <ItemTemplate>
            <asp:Literal ID="ltlGroupName" runat="server"></asp:Literal>
  ...
  <div class="popover popover-static">
    <h3 class="popover-title">系统用户组</h3>
    <div class="popover-content">
    
      <div class="tips"> 系统用户组是系统预定义的用户组，预留了从论坛管理员到游客的 8 个系统等级。 </div>

      <asp:dataGrid id="MyDataGrid3" showHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" runat="server">
        <Columns>
        <asp:TemplateColumn HeaderText="会员组名称">
          <ItemTemplate>
            <asp:Literal ID="ltlGroupName" runat="server"></asp:Literal>
