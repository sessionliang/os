<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundUser" %>
  ...
  <div class="well well-small">
    <table class="table table-noborder">
      <tr>
        <td>
          会员组：
          <asp:DropDownList ID="ddlUserGroup" AutoPostBack="true" OnSelectedIndexChanged="Search_OnClick" runat="server"></asp:DropDownList>
          每页显示条数：
    ...
    <asp:Repeater ID="rptContents" runat="server">
      <itemtemplate>
        <tr>
          ...
          <td><asp:Literal ID="ltlCreationDate" runat="server"></asp:Literal></td>
          <td><asp:Literal ID="ltlLastActivityDate" runat="server"></asp:Literal></td>
          <td><asp:Literal ID="ltlCredits" runat="server"></asp:Literal></td>
