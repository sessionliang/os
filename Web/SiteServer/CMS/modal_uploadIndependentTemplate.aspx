<%@ Page Language="C#" Trace="false" Inherits="SiteServer.CMS.BackgroundPages.Modal.UploadIndependentTemplate" %>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table table-noborder table-hover">
    <tr>
      <td width="120"><bairong:help HelpText="选择导入独立模板的方式" Text="导入方式：" runat="server" ></bairong:help></td>
      <td>
