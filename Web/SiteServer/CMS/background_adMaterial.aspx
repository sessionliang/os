<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundAdMaterial" %>
...
<form id="Form1" class="form-inline" runat="server">
  ...
  <asp:dataGrid id="dgContents" showHeader="true" AutoGenerateColumns="false" DataKeyField="AdMaterialID" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" gridlines="none" runat="server">
    <Columns>
     ...
     <asp:TemplateColumn >
        <ItemTemplate> <a href="background_adMaterial.aspx?PublishmentSystemID=<%=Request.QueryString["PublishmentSystemID"]%>&AdMaterialID=<%# DataBinder.Eval(Container.DataItem,"AdMaterialID")%>&Delete=True" onClick="javascript:return confirm('此操作将删除广告物料“<%# DataBinder.Eval(Container.DataItem,"AdMaterialName")%>”，确认吗？');">删除</a> </ItemTemplate>
        <ItemStyle Width="50" cssClass="center" />
      </asp:TemplateColumn>
      <asp:TemplateColumn
