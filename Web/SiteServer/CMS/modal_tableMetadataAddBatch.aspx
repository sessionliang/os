<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.Modal.TableMetadataAddBatch" %>
    ...
    <form class="form-inline" runat="server" id="MyForm">
        ...
        <script language="javascript">
            ...
            $(function () {
                ...
                $("#addDiv").click(function () {
                    ...
                    htmlTmp += '</td>';
                    htmlTmp += '<td>';
                    htmlTmp += '<select name="canBeNull">';
                    htmlTmp += '<option value="true">是</option>';
                    htmlTmp += '<option value="false">否</option>';
                    htmlTmp += '</select>';
                    htmlTmp += '</td>';
                    htmlTmp += '<td>';
                    htmlTmp += '<input name="dbDefaultValue" type="text" />';
                    htmlTmp += '</td>';
                    htmlTmp += '<td>';
        ...
        <table id="tb" class="table table-bordered table-hover">
            ...
            <tr class="data" id="tr1">
                ...
                <td>
                    <select name="canBeNull">
                        <option value="true">是</option>
                        <option value="false">否</option>
                    </select>
                </td>
                <td>
                    <input name="dbDefaultValue" type="text" />
                </td>
                <td></td>
            </tr>
        </table>
