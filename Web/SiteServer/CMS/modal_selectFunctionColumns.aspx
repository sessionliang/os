<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.Modal.SelectFunctionColumns" Trace="false"%>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table width="100%">
    <tr>
      <td>
        需要的字段：<input type="checkbox" id="check_groups" onClick=checkAll(document.getElementById("Group"),this.checked);><label for="check_groups">全选</label>
        <span id="Group">
