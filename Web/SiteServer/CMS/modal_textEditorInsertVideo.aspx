<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.Modal.TextEditorInsertVideo" %>
...
<bairong:alerts runat="server" text="请选择插入视频的方式"></bairong:alerts>
  ...
  $(document).ready(function(){
    new AjaxUpload('uploadFile', {
     action: 'modal_textEditorInsertVideo.aspx?upload=true&PublishmentSystemID=<%=base.PublishmentSystemID%>',
     name: "filedata",
     data: {},
