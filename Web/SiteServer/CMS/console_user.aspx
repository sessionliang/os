    ...
    <asp:Repeater ID="rptContents" runat="server">
      <itemtemplate>
        <tr>
          ...
          <td class="center"><asp:Literal ID="ltlCredits" runat="server"></asp:Literal></td>
          <td class="center"><asp:Literal ID="ltlCreateDate" runat="server"></asp:Literal></td>
          <td class="center"><asp:Literal ID="ltlCreateIPAddress" runat="server"></asp:Literal></td>
          <td width="120"><asp:Literal ID="ltlLastActivityDate" runat="server"></asp:Literal></td>
          <td class="center"><asp:HyperLink NavigateUrl="javascript:;" ID="hlChangePassword" Text="重设密码" runat="server"></asp:HyperLink></td>
          <td class="center"><asp:HyperLink ID="hlEditLink" Text="编辑" runat="server"></asp:HyperLink></td>
