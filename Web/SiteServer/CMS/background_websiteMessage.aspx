<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundWebsiteMessage" %>
...
<form class="form-inline" runat="server">
  ...
  <asp:dataGrid id="dgContents" showHeader="true" AutoGenerateColumns="false" DataKeyField="WebsiteMessageID" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" gridlines="none" runat="server">
    <Columns>
      <asp:TemplateColumn
        HeaderText="留言名称">
        <ItemTemplate> &nbsp;<%#DataBinder.Eval(Container.DataItem,"WebsiteMessageName")%> </ItemTemplate>
      ...
      <asp:TemplateColumn>
        <ItemTemplate> <a href="background_input.aspx?Delete=True&PublishmentSystemID=<%=base.PublishmentSystemID%>&WebsiteMessageID=<%# DataBinder.Eval(Container.DataItem,"WebsiteMessageID")%>" onClick="javascript:return confirm('此操作将删除留言“<%# DataBinder.Eval(Container.DataItem,"WebsiteMessageName")%>”及相关数据，确认吗？');">删除</a> </ItemTemplate>
        <ItemStyle Width="50" cssClass="center" />
      </asp:TemplateColumn>
    </Columns>
  </asp:dataGrid>
  ...
  <ul class="breadcrumb breadcrumb-button">
    <asp:Button class="btn btn-success" id="AddWebsiteMessage" Text="添加留言" runat="server" />
    <asp:Button class="btn" id="Import" Text="导入留言" runat="server" />
  </ul>
