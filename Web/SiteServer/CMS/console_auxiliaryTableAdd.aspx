      ...
      <table class="table noborder table-hover">
        <tr>
          ...
          <td>
            ...
            <asp:RegularExpressionValidator runat="server" ControlToValidate="TableENName" ValidationExpression="[a-zA-Z0-9_]+" ErrorMessage=" 只允许包含字母、数字以及下划线" Display="Dynamic" />
            <br>
      ...
      <table class="table noborder">
        <tr>
          <td class="center">
            ...
            <input type="button" class="btn" value="返 回" onClick="javascript:location.href='console_auxiliaryTable.aspx';" />
          </td>
        </tr>
      </table>
