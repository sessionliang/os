...
<frameset id="frame" framespacing="0" border="false" cols="180,*" frameborder="0" scrolling="yes">
	<frame name="tree" scrolling="auto" marginwidth="0" marginheight="0" src="background_functionNodeTree.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>&LoadingType=CompareNodeTree&RightPageURL=background_compareMainContent.aspx" >
