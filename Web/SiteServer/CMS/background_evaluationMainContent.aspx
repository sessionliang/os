<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundEvaluationContent" %>
  ...
  <div class="well well-small">
    <table class="table table-noborder">
      ...
      <tr>
        <td>--%>
          <%--审核状态：--%>
          <asp:DropDownList ID="IsChecked" class="input-medium" AutoPostBack="true" OnSelectedIndexChanged="Search_OnClick" runat="server" Visible="false">
    ...
    <asp:Repeater ID="rptContents" runat="server">
      <itemtemplate>
        <tr>
          ...
          <td class="center">
            <input type="checkbox" name="ContentIDCollection" value='<%#DataBinder.Eval(Container.DataItem, "ECID")%>' />
          </td>
        </tr>
      </itemtemplate>
    </asp:Repeater>
