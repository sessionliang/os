          ...
          <asp:DropDownList ID="PeriodIntervalType" class="input-small" runat="server"></asp:DropDownList>
            ...
            <asp:PlaceHolder ID="PlaceHolder_Publish" Visible="false" runat="server">
                <tr>
                    <td>选择发布类型：</td>
                    <td>
                        <asp:CheckBoxList ID="PublishTypes" RepeatDirection="Horizontal" class="noborder checkboxlist" RepeatColumns="4" runat="server"></asp:CheckBoxList></td>
                </tr>
                <asp:PlaceHolder ID="PlaceHolder_Publish_JustInTime" Visible="false" runat="server">
                    <tr>
                        <td>
                            <bairong:Help HelpText="实时监听的文件类型" Text="监听文件类型：" runat="server"></bairong:Help>
                        </td>
                        <td>
                            <asp:TextBox ID="PublishFilter" runat="server"></asp:TextBox>
                            <br>
            ...
            <asp:PlaceHolder ID="PlaceHolder_Create" Visible="false" runat="server">
                ...
                <tr>
                    <td>
                        <bairong:Help HelpText="生成站点地图(SiteMap)" Text="生成站点地图(SiteMap)：" runat="server"></bairong:Help>
                    </td>
                    <td>
                        <asp:CheckBox ID="CreateIsCreateSiteMap" runat="server" Text="生成"></asp:CheckBox></td>
                </tr>
            </asp:PlaceHolder>
            ...
            <asp:PlaceHolder ID="PlaceHolder_Check" Visible="false" runat="server">
                <tr>
                    <td>
                        <bairong:Help HelpText="选择需要审核的对象" Text="需要审核的对象：" runat="server"></bairong:Help>
                    </td>
                    <td>
                        <asp:ListBox ID="CheckChannelIDCollection" SelectionMode="Multiple" Rows="13" runat="server"></asp:ListBox>
                        &nbsp;<asp:CheckBox ID="CheckIsCheckAll" class="checkbox inline" Text="审核全部" runat="server"></asp:CheckBox>
                    </td>
                </tr>
            </asp:PlaceHolder>
            <asp:PlaceHolder ID="PlaceHolder_UnCheck" Visible="false" runat="server">
                <tr>
                    <td>
                        <bairong:Help HelpText="选择需要下架的对象" Text="需要下架的对象：" runat="server"></bairong:Help>
                    </td>
                    <td>
                        <asp:ListBox ID="UnCheckChannelIDCollection" SelectionMode="Multiple" Rows="13" runat="server"></asp:ListBox>
                        &nbsp;<asp:CheckBox ID="UnCheckIsCheckAll" class="checkbox inline" Text="下架全部" runat="server"></asp:CheckBox>
                    </td>
                </tr>
            </asp:PlaceHolder>
        </table>
