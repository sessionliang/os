<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundAdvAdd" %>
      ...
      <table class="table noborder">
        <tr>
          <td class="center">
            ...
            <input class="btn" type="button" onClick="location.href='background_adv.aspx?PublishmentSystemID=<%=PublishmentSystemID%>';return false;" value="返 回" />
          </td>
        </tr>
      </table>
