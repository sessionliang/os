...
<form class="form-inline" runat="server">
  ...
  <asp:dataGrid id="dgContents" showHeader="true" AutoGenerateColumns="false" DataKeyField="AdvertisementName" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" gridlines="none" runat="server">
    <Columns>
      ...
      <asp:TemplateColumn >
        <ItemTemplate> <a href="background_advertisementAdd.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>&AdvertisementName=<%# DataBinder.Eval(Container.DataItem,"AdvertisementName")%>">编辑</a> </ItemTemplate>
        <ItemStyle Width="50" cssClass="center" />
      </asp:TemplateColumn>
      <asp:TemplateColumn >
        <ItemTemplate> <a href="background_advertisement.aspx?PublishmentSystemID=<%=base.PublishmentSystemID%>&AdvertisementName=<%# DataBinder.Eval(Container.DataItem,"AdvertisementName")%>&Delete=True" onClick="javascript:return confirm('此操作将删除广告“<%# DataBinder.Eval(Container.DataItem,"AdvertisementName")%>”，确认吗？');">删除</a> </ItemTemplate>
        <ItemStyle Width="50" cssClass="center" />
      </asp:TemplateColumn>
      <asp:TemplateColumn
