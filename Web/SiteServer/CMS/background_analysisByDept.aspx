<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundAnalysisByDept" %>
...
<body>
    ...
    <bairong:DateTimeTextBox ID="EndDate" class="input-small" Columns="30" runat="server" />
            所属部门： 
            <asp:DropDownList ID="ddlDepartment" class="input" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged"></asp:DropDownList>
            管理员：<asp:TextBox runat="server" ID="tbUserName" class="input-small" Columns="30"></asp:TextBox>
        ...
        <div class="popover popover-static" style="display: none;">
            <h3 class="popover-title">按部门统计</h3>
