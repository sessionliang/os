<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundCompare" %>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="well well-small">
            <table class="table table-noborder">
                <tr>
                    <td>比较页面：<asp:Literal ID="ltlTarget" runat="server" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table id="contents" class="table table-bordered table-hover">
            <tr class="info thead">
                ...
                <td width="180">反馈人</td>
                <td>反馈描述</td>
                <td width="70">产品1评分</td>
                <td width="70">产品2评分</td>
                <td width="70">IP地址</td>
                <td width="110">反馈时间</td>
                <td width="30">&nbsp;</td>
                <td width="20">
            ...
            <asp:Repeater ID="rptContents" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="center">
                            <asp:Literal ID="ltlCompositeScore1" runat="server"></asp:Literal>
                        </td>
                        <td class="center">
                            <asp:Literal ID="ltlCompositeScore2" runat="server"></asp:Literal>
                        </td>
                        <td>
                        ...
                        <td class="center">
                            <input type="checkbox" name="ContentIDCollection" value='<%#DataBinder.Eval(Container.DataItem, "CCID")%>' />
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
        ...
        <ul class="breadcrumb breadcrumb-button">
            ...
            <asp:Button class="btn" ID="btnAnalysis" runat="server" Visible="false" Text="字段统计"></asp:Button>
