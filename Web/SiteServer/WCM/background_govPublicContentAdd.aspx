<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.WCM.BackgroundPages.BackgroundGovPublicContentAdd" %>
  ...
  <div class="popover popover-static">
    ...
    <div class="popover-content">
      ...
      <table class="table table-fixed noborder" style="position:relative;top:-30px;">
        ...
        <site:AuxiliarySingleControl ID="ascTitle" runat="server"/>
        <tr>
          <td height="30">索引号：</td>
