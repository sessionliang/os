<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundMLibManageTableStyleContent" %>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="well well-small">
            <table class="table table-noborder">
                <tr>
                    <td>站点：                               
  <asp:Literal ID="PublishmentSystemName" runat="server" />
                    </td>
                    <td>栏目： 
  <asp:Literal ID="NodeName" runat="server" />
                    </td>  
                    <td width="70%"></td>         
                </tr>
            </table>
        ...
        <ul class="breadcrumb breadcrumb-button">
            <asp:Button class="btn btn-success" ID="SaveStyle" OnClick="Submit_OnClick" Text="保存所选字段" runat="server" />
            <asp:Button class="btn" ID="AddStyle" Text="新增虚拟字段" runat="server" />
            <asp:Button class="btn" ID="btnReturn" OnClick="Return_OnClick" Text="返回" runat="server" />
        </ul>
