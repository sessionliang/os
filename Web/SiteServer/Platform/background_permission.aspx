<%@ Page Language="C#" validateRequest="false" Inherits="BaiRong.BackgroundPages.BackgroundPermission" %>
    ...
    <div class="popover-content">
      ...
      <table class="table noborder table-hover">
        <tr>
          ...
          <td>
          <asp:ListBox ID="lbHorizontalLevel" Rows="10" runat="server"></asp:ListBox>
          </td>
  ...
  <table class="table noborder">
    <tr>
      <td class="center">
        ...
        <input class="btn" type="button" onClick="location.href='background_userLevel.aspx';return false;" value="返 回" />
      </td>
    </tr>
  </table>
