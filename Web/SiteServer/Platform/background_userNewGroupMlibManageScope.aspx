<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundUserNewGroupMLibManageScope" %>
...
<form class="form-inline" runat="server">
  ...
  <bairong:alerts text="本页面设置对应站点的具体栏目，只有在投稿设置中保存过的栏目才可以选择；确认后需投稿设置页面再次点击确认才能最终保存" runat="server" />
