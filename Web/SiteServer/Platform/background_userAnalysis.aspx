﻿<%@ Page Language="C#" Inherits="BaiRong.BackgroundPages.BackgroundUserAnalysis" %>
    ...
    <form class="form-inline" runat="server">
      ...
      <asp:DropDownList ID="ddlXType" runat="server"></asp:DropDownList>
        ...
        <div class="popover popover-static">
            <h3 class="popover-title">用户增加最近<%=count %><%=BaiRong.Model.EStatictisXTypeUtils.GetText(BaiRong.Model.EStatictisXTypeUtils.GetEnumType(base.GetQueryString("XType"))) %>分配图表</h3>
