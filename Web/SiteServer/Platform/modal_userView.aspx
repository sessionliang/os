<%@ Page Language="C#" Inherits="BaiRong.BackgroundPages.Modal.UserView" Trace="false"%>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table table-striped">
    ...
    <tr>
      <td width="118" height="25">创建人：</td>
      <td><asp:Literal id="ltlCreateUserName" runat="server" /></td>
      <td>最后活动时间：</td>
