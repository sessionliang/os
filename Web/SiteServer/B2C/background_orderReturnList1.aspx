<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.B2C.BackgroundPages.BackgroundOrderReturnList1" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <ul class="nav nav-pills" id="myTab">
            ...
            <li class="active"><a href="javascript:;">处理中(<asp:Literal runat="server" ID="ltlCLZCount"></asp:Literal>)</a></li>
            <li><a href="background_orderReturnList2.aspx?publishmentSystemID=<%=this.PublishmentSystemID %>">已处理(<asp:Literal runat="server" ID="ltlYCLCount"></asp:Literal>)</a></li>
        </ul>
        ...
        <ul class="breadcrumb breadcrumb-button">
            <asp:HyperLink ID="hlReturnOrderStatusPass" class="btn btn-success" runat="server" Text="已收货"></asp:HyperLink>
            <asp:HyperLink ID="hlReturnOrderStatusUnPass" class="btn btn-success" runat="server" Text="未收货"></asp:HyperLink>
            <asp:HyperLink ID="hlReturnMoneyStatusPass" class="btn btn-success" runat="server" Text="已退款"></asp:HyperLink>
            <asp:HyperLink ID="hlReturnMoneyStatusUnPass" class="btn btn-success" runat="server" Text="未退款"></asp:HyperLink>
        </ul>
    </form>
</body>
</html>
