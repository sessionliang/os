<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundOrderListAll" %>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="well well-small">
          ...
          <asp:DropDownList ID="ddlShipmentStatus" class="input-small" AutoPostBack="true" OnSelectedIndexChanged="Search_OnClick" runat="server"></asp:DropDownList>
                ...
                <tr>
                    <td>商城：
                        <asp:DropDownList ID="ddlPublishmentSystem" class="input-small" Width="200" AutoPostBack="true" OnSelectedIndexChanged="Search_OnClick" runat="server"></asp:DropDownList>
                        订单号：
