<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundConsultation" %>
    ...
    <asp:Repeater ID="rptContents" runat="server">
      <itemtemplate>
        <tr>
          ...
          <td>&nbsp;<asp:Literal ID="ltlQuestion" runat="server"></asp:Literal></td>
          <td><asp:Literal ID="ltlConsultationType" runat="server"></asp:Literal></td>
          ...
          <td><asp:Literal ID="ltlAnswer" runat="server"></asp:Literal></td>
