<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.B2C.BackgroundPages.BackgroundOrderReturnList" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <ul class="nav nav-pills" id="myTab">
            <li class="active"><a href="javascript:;">未处理(<asp:Literal runat="server" ID="ltlWCLCount"></asp:Literal>)</a></li>
        ...
        <ul class="breadcrumb breadcrumb-button">
            <asp:HyperLink ID="hlAuditStatusPass" class="btn btn-success" runat="server" Text="受理"></asp:HyperLink>
            <asp:HyperLink ID="hlAuditStatusUnPass" class="btn btn-success" runat="server" Text="不受理"></asp:HyperLink>
        </ul>
    </form>
</body>
</html>
