<%@ Page Language="C#" Inherits="UserCenter.WCM.Pages.Modal.TextEditorInsertVideo" %>
...
$(document).ready(function(){
  new AjaxUpload('uploadFile', {
   action: 'modal_textEditorInsertVideo.aspx?upload=true&PublishmentSystemID=<%=Request.QueryString["PublishmentSystemID"]%>',
   name: "filedata",
   data: {},
