<%@ Page Language="C#" Trace="false" Inherits="UserCenter.WCM.BackgroundPages.UploadWord" %>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table noborder table-hover">
    ...
    <asp:CheckBox CssClass="checkbox inline" id="cbIsClearFormat" Checked="true" runat="server" Text="清除格式"/><br />
    ...
    <asp:CheckBox CssClass="checkbox inline" id="cbIsClearImages" runat="server" Text="清除图片"/><br />
    <asp:CheckBox CssClass="checkbox inline" id="cbIsClearEmptyRows" runat="server" Text="清除空行"/>
    <asp:CheckBox CssClass="checkbox inline" id="cbIsClearATag" runat="server" Text="清除链接"/>
    <asp:CheckBox CssClass="checkbox inline" id="cbIsClearTitleTag" runat="server" Text="清除标题格式"/>
    <asp:CheckBox CssClass="checkbox inline" id="cbIsCenterTables" runat="server" Text="表格居中"/></td>
    </tr>    
  </table>
