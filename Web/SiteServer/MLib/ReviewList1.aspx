<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.CMS.BackgroundPages.MLib.ReviewList1" %>
...
<head>
    ...
    <script>
        function Reference(pid, nid, id) {
            openWindow('选择引用方', 'modal_contentReferenceSelect.aspx?PublishmentSystemID=' + pid + '&NodeID=' + nid + '&ID=' + id
                , 600, 580, 'true'); return false;
        }
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <ul class="nav nav-pills">
            <li id="tab1" <%=IsShowTab %>><a href="ReviewList.aspx?PublishmentSystemID=<%=Request.QueryString["PublishmentSystemID"] %>&NodeID=<%=Request.QueryString["nodeid"] %>">待审核稿件(<asp:Literal runat="server" ID="ltlContentCount1"></asp:Literal>)</a></li>
            <li id="tab2" class="active"><a href="javascript:;">所有稿件(<asp:Literal runat="server" ID="ltlContentCount2"></asp:Literal>)</a></li>
        </ul>
        ...
        <div class="well well-small">
            <a href="ReviewAdd.aspx?PublishmentSystemID=<%=Request.QueryString["PublishmentSystemID"] %>&NodeID=<%=Request.QueryString["nodeid"] %>">
                <img style="margin-right: 3px" src="/SiteFiles/bairong/icons/add.gif" align="absMiddle">添加内容</a>
