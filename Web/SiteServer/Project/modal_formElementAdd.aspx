<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.Modal.FormElementAdd" Trace="false"%>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table table-noborder table-hover">
    <tr>
      <td width="120">分页：</td>
      <td><asp:DropDownList id="ddlPageID" OnSelectedIndexChanged="ReFreshPageID" AutoPostBack="true" runat="server" /></td>
      <td width="120">组别：</td>
      <td><asp:DropDownList id="ddlGroupID" runat="server" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>显示帮助提示：</td>
      <td><asp:TextBox Columns="60" id="HelpText" runat="server" />
        <asp:RegularExpressionValidator runat="server" ControlToValidate="HelpText"
              ValidationExpression="[^']+" errorMessage=" *" foreColor="red" display="Dynamic" /></td>
      <td>图片提示：</td>
      <td><asp:TextBox Columns="60" id="ImageUrl" runat="server" />
