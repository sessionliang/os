<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.Modal.FormElementValidateAdd" Trace="false"%>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table table-noborder table-hover">
    <tr>
      <td width="160"><bairong:help HelpText="设置是否对此字段启用表单验证" Text="是否启用表单验证：" runat="server" ></bairong:help></td>
      <td><asp:RadioButtonList id="IsValidate" RepeatDirection="Horizontal" OnSelectedIndexChanged="Validate_SelectedIndexChanged" AutoPostBack="true" runat="server">
    ...
    <asp:PlaceHolder ID="phValidate" runat="server">
      <tr>
        ...
        <td><asp:RadioButtonList id="IsRequired" RepeatDirection="Horizontal" runat="server">
            <asp:ListItem Text="是" />
