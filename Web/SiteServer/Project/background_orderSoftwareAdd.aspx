<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.Project.BackgroundPages.BackgroundOrderSoftwareAdd" %>
      ...
      <table class="table noborder table-hover">
        ...
        <tr>
          ...
          <td colspan="3">
            ...
            <input name="Duration" type="text" class="input-mini" id="Duration" value="<%=GetValue("Duration")%>" /> 月
          </td>
        </tr>
        <tr>
          ...
          <td>
            <select name="BizType" id="BizType">
              <option <%=GetSelected("BizType", "SiteServer CMS 多站点版本（含服务）")%> value="SiteServer CMS 多站点版本（含服务）">SiteServer CMS 多站点版本（含服务）</option>
              <option <%=GetSelected("BizType", "SiteServer CMS 单站点版本（含服务）")%> value="SiteServer CMS 单站点版本（含服务）">SiteServer CMS 单站点版本（含服务）</option>
              <option <%=GetSelected("BizType", "SiteServer BBS 论坛系统")%> value="SiteServer BBS 论坛系统">SiteServer BBS 论坛系统</option>
              <option <%=GetSelected("BizType", "SiteServer CMS 多站点版本")%> value="SiteServer CMS 多站点版本">SiteServer CMS 多站点版本</option>
              <option <%=GetSelected("BizType", "SiteServer CMS 单站点版本")%> value="SiteServer CMS 单站点版本">SiteServer CMS 单站点版本</option>
            </select>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input name="MobanID" type="text" class="input-large" id="MobanID" value="<%=GetValue("MobanID")%>" />
          </td>
