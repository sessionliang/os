<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.BackgroundApplyToDoneDetail" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    <h3 class="popover-title">处理完毕办件信息(<asp:Literal ID="ltlProjectName" runat="server"></asp:Literal>)</h3>
                ...
                <td><table class="applyTable" border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;table-layout:fixed">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                        <td bgcolor="#f0f6fc" class="attributeName">审核人</td>
                        <td><asp:Literal ID="ltlCheckUserName" runat="server"></asp:Literal></td>
                        <td bgcolor="#f0f6fc" class="attributeName">审核时间</td>
