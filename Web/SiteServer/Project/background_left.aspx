<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.BackgroundLeft" Trace="False" enableViewState = "false"%>

<%@ Register TagPrefix="bairong" Namespace="BaiRong.Controls" Assembly="BaiRong.Controls" %>

<%@ Register TagPrefix="project" Namespace="SiteServer.Project.Controls" Assembly="SiteServer.Project" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<form runat="server">
  <table class="table table-condensed noborder table-hover">
    <project:NavigationTree ID="navigationTree" runat="server" />
  </table>
</form>
