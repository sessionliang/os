<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.BackgroundApplyToReplyDetail" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    <h3 class="popover-title">待办理办件信息(<asp:Literal ID="ltlProjectName" runat="server"></asp:Literal>)</h3>
    ...
    <table id="divSwitchTo" class="table table-bordered action" style="display:none">
      ...
      <tr>
        <td>
          <table class="table table-noborder">
            <tr>
              <td colspan="2"><div class="tips">注意：转办后办件将由对应负责人进行处理</div></td>
            </tr>
            <tr>
