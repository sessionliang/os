...
namespace BaiRong.BackgroundPages.Modal
{
	public class UserImport : BackgroundBasePage
	{
        ...
        public static string GetOpenWindowString()
        {
            ...
            return PageUtilityPF.GetOpenWindowString("导入用户", "modal_userImport.aspx", arguments, 450, 350);
        }
        ...
        public void ImportContentsByExcelFile(string excelFilePath, bool isOverride, int importStart, int importCount)
        {
            ...
            foreach (UserInfo userInfo in userInfoArrayList)
            {
                ...
                {
                    if (BaiRongDataProvider.UserDAO.IsExists(string.Empty, userInfo.UserName))
                    {
