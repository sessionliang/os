...
namespace BaiRong.BackgroundPages.Modal
{
	public class UserExport : BackgroundBasePage
	{
        ...
        public static string GetOpenWindowString()
        {
            ...
            return PageUtilityPF.GetOpenWindowString("导出用户", "modal_userExport.aspx", arguments, 380, 250);
        }
        ...
        public override void Submit_OnClick(object sender, EventArgs E)
        {
            ...
            UserExport.CreateExcelFileForUsers(BaiRongDataProvider.UserDAO.TABLE_NAME, filePath, ETriStateUtils.GetEnumType(this.CheckedState.SelectedValue));
