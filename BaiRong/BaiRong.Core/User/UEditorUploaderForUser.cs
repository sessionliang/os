      ...
      */
        public Hashtable upFile(HttpContext cxt)
        {
            try
            {
                ...
                string localDirectoryPath = PathUtils.GetUserUploadDirectoryPath(UserManager.Current.UserName);
                string localFileName = PathUtils.GetUserUploadFileName(originalName);
