...
namespace BaiRong.Core
{
    public class HtmlClearUtils
    {
        ...
        public static string ClearFormat(string html)
        {
            ...
            html = HtmlClearUtils.ClearWordStyle(html);
            string[] el = new string[] { "p", "strong", "ol", "ul", "li", "table", "tr", "td" };
            foreach (string s in el)
            {
                try
                {
                    html = HtmlClearUtils.ClearElementAttributes(html, s);
                }
                catch
                {
                    continue;
            ...
            foreach (string s in el)
            {
                try
                {
                    html = HtmlClearUtils.RemoveElementTag(html, s);
                }
                catch
                {
                    continue;
