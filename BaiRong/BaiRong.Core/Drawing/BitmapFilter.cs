...
namespace BaiRong.Core.Drawing
{
    public class BitmapFilter
    {
        ...
        {
            b = BitmapFilter.RotateLeftAndFlipVert(b);
            BitmapFilter.Flip(b, false, true);
            return b;
        }
        ...
        {
            b = BitmapFilter.RotateLeftAndFlipVert(b);
            BitmapFilter.Flip(b, true, false);
            return b;
        }

        public static Bitmap RotateLeftAndFlipHorz(Bitmap b)
        {
            b = BitmapFilter.RotateLeft(b);
            BitmapFilter.Flip(b, true, false);
            return b;
        }
        ...
        public static bool RandomJitter(Bitmap b, short nDegree)
        {
            ...
            short nHalf = (short)Math.Floor(Convert.ToDouble(nDegree / 2));
