...
using SiteServer.Service.Uninstall.Properties;

namespace SiteServer.Service.Uninstall
{
    static class Program
    {
        ...
        static void Main()
        {
            try
            {
                ...
                if (MessageBox.Show(Resources.Uninstall_Question, Resources.Uninstall + " " + Globals.ProductName, MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
