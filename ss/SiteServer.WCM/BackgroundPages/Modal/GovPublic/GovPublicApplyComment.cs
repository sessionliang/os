...
{
	public class GovPublicApplyComment : BackgroundBasePage
	{
        ...
        public static string GetOpenWindowString(int publishmentSystemID)
        {
            ...
            return PageUtilityWCM.GetOpenWindowStringWithCheckBoxValue("批示", "modal_govPublicApplyComment.aspx", arguments, "IDCollection", "请选择需要批示的申请！", 450, 320);
        }
        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    GovPublicApplyRemarkInfo remarkInfo = new GovPublicApplyRemarkInfo(0, base.PublishmentSystemID, applyID, EGovPublicApplyRemarkType.Comment, this.tbCommentRemark.Text, AdminManager.Current.DepartmentID, AdminManager.Current.UserName, DateTime.Now);
                    DataProvider.GovPublicApplyRemarkDAO.Insert(remarkInfo);

                    GovPublicApplyManager.Log(base.PublishmentSystemID, applyID, EGovPublicApplyLogType.Comment);
                }
