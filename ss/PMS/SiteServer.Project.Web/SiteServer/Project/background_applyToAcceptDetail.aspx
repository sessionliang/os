<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.BackgroundApplyToAcceptDetail" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    <h3 class="popover-title">待受理办件信息(<asp:Literal ID="ltlProjectName" runat="server"></asp:Literal>)</h3>
        ...
        <asp:PlaceHolder ID="phReply" Visible="false" runat="server">
          <tr>
            ...
            <td><table border=0 cellspacing=0 cellpadding=0 class="applyTable" style="width:100%; border:1px solid silver">
                ...
                <tr>
                  <td align="right" bgcolor="#f0f6fc" class="attributeName">回复内容</td>
          ...
          <td>
            <table class="table table-noborder">
              ...
              <tr>
                <td class="center">&nbsp;</td>
                <td>
                  <asp:Button class="btn btn-primary" OnClick="Accept_OnClick" Text="提 交" runat="server"></asp:Button>
        ...
        <tr>
          <td>
            <table class="table table-noborder">
              ...
              <tr>
                <td class="center" width="120">办理结果：</td>
