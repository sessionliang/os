<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.BackgroundRequestAnswer"%>
        ...
        <td>
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>
                <asp:Literal id="ltlLicense" runat="server" />
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                <asp:Literal id="ltlContact" runat="server" />
              </td>
            </tr>
            <tr>
              <td>
