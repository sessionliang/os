<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.Modal.FormGroupAdd" Trace="false"%>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table noborder table-hover">
    ...
    <tr>
      <td>组图标：</td>
      <td><asp:TextBox Columns="25" MaxLength="50" id="tbIconUrl" runat="server" /></td>
    </tr>
  </table>
