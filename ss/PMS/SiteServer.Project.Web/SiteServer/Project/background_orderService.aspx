<%@ Page Language="C#" Inherits="SiteServer.Project.BackgroundPages.BackgroundOrderService" %>
    ...
    <asp:Repeater ID="rptContents" runat="server">
      <itemtemplate>
        <tr>
          ...
          <td class="center"><asp:Literal ID="ltlRelatedOrderID" runat="server"></asp:Literal></td>
