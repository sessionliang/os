<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.Project.BackgroundPages.RequestAdd" %>
...
<form class="form-inline" runat="server">
  ...
  <ul class="nav nav-pills">
    <li class="active"><a href="javascript:;">发起工单</a></li>
    <li><a href="request.aspx?domain=<%=Request.QueryString["domain"]%>&licenseID=<%=Request.QueryString["licenseID"]%>">工单列表</a></li>
  </ul>
