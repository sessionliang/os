<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.GeXia.BackgroundPages.BackgroundDMTemplateAdd" %>
    ...
    <div class="popover-content">
      ...
      <table class="table noborder table-hover">
        <tr>
          ...
          <td>
            <input name="Title" type="text" id="Title" value="<%=GetValue("Title")%>" />
          </td>
        </tr>
        <tr>
