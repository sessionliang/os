...
namespace SiteServer.Project.Provider.Data.SqlServer
{
    public class MobanDAO : DataProviderBase, IMobanDAO
	{
        ...
        public int Insert(MobanInfo mobanInfo)
        {
            ...
            string SQL_INSERT = BaiRongDataProvider.TableStructureDAO.GetInsertSqlString(mobanInfo.Attributes, this.ConnectionString, MobanInfo.TableName, out parms);
        ...
        public void Update(MobanInfo mobanInfo)
        {
            ...
            mobanInfo.BeforeExecuteNonQuery();
            IDbDataParameter[] parms = null;
            string SQL_UPDATE = BaiRongDataProvider.TableStructureDAO.GetUpdateSqlString(mobanInfo.Attributes, this.ConnectionString, MobanInfo.TableName, out parms);
        ...
        public MobanInfo GetMobanInfo(int mobanID)
        {
            ...
            string SQL_SELECT = BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(this.ConnectionString, MobanInfo.TableName, 0, SqlUtils.Asterisk, SQL_WHERE, null);
        ...
        {
            return BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(this.ConnectionString, MobanInfo.TableName, 0, SqlUtils.Asterisk, null, null);
        }
        ...
        public string GetSelectString(string sn, string keyword)
        {
            ...
            return BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(this.ConnectionString, MobanInfo.TableName, 0, SqlUtils.Asterisk, whereString, null);
        }
