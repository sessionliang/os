...
namespace SiteServer.Project.Core
{
    public class ConfigurationManager
    {
        ...
        private static string innerConnectionString = "";
        private static string outerConnectionString = "";
        ...
        public static string InnerConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(innerConnectionString))
                {
                    innerConnectionString = ConfigUtils.GetAppSettingValue("ConnectionString");
                }
                return innerConnectionString;
            }
        }

        public static string OuterConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(outerConnectionString))
                {
                    outerConnectionString = ConfigUtils.GetAppSettingValue("ConnectionStringBRS");
                }
                return outerConnectionString;
            }
        }
    }
}
