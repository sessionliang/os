...
{
    public class BackgroundProjectContractAnalysis : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            for (; dateTime <= DateTime.Now; dateTime = dateTime.AddMonths(1))
            {
                ...
                int amountPaid = DataProvider.ProjectDAO.GetAmountNet(dateTime.Year, dateTime.Month);

                StringBuilder builder1 = new StringBuilder();
                StringBuilder builder2 = new StringBuilder();
                Dictionary<int, int> dictionary = DataProvider.ProjectDAO.GetProjectIDAmountNetDictionary(dateTime.Year, dateTime.Month);
