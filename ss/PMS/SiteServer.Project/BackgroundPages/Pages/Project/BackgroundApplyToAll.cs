...
{
    public class BackgroundApplyToAll : BackgroundApplyToBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!IsPostBack)
            {
                ...
                EApplyStateUtils.AddListItems(this.ddlState);
                ...
                ArrayList addUserNameArrayList = DataProvider.ApplyDAO.GetAddUserNameArrayList(base.ProjectID);
        ...
        protected override string GetSelectString()
        {
            ...
            {
                return DataProvider.ApplyDAO.GetSelectString(base.projectID, base.Request.QueryString["state"], TranslateUtils.ToInt(base.Request.QueryString["typeID"]), base.Request.QueryString["addUserName"], base.Request.QueryString["userName"], base.Request.QueryString["keyword"]);
            }
            else
            {
                return DataProvider.ApplyDAO.GetSelectString(base.projectID);
            }
        }
        ...
        protected override string PageUrl
        {
            get
            {
                ...
                {
                    _pageUrl = BackgroundApplyToAll.GetRedirectUrl(base.ProjectID, TranslateUtils.ToBool(this.ddlTaxis.SelectedValue), this.ddlState.SelectedValue, this.ddlTypeID.SelectedValue, this.ddlAddUserName.SelectedValue, this.ddlUserName.SelectedValue, this.tbKeyword.Text, TranslateUtils.ToInt(Request.QueryString["page"], 1));
                }
                return _pageUrl;
            }
        }
        ...
        {
            return string.Format("background_ApplyToAll.aspx?ProjectID={0}&isTaxisDESC={1}&state={2}&typeID={3}&addUserName={4}&userName={5}&keyword={6}&page={7}", projectID, isTaxisDESC, state, typeID, addUserName, userName, keyword, page);
        }
    }
}
