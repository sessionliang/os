    ...
    public class BackgroundApplyToBasePage : BackgroundBasePage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    this.hlAccept.Attributes.Add("onclick", Modal.ApplyAccept.GetShowPopWinString(base.ProjectID));
                }
                if (this.hlDeny != null)
                {
                ...
                if (this.hlRedo != null)
                {
                    this.hlRedo.Attributes.Add("onclick", Modal.ApplyRedo.GetShowPopWinString(base.ProjectID));
                }
                if (this.hlSetting != null)
                {
                    this.hlSetting.Attributes.Add("onclick", Modal.ApplySetting.GetShowPopWinString(base.ProjectID));
                }
                if (this.hlSwitchTo != null)
                {
                    this.hlSwitchTo.Attributes.Add("onclick", Modal.ApplySwitchTo.GetShowPopWinString(base.ProjectID));
                }
                if (this.hlTranslate != null)
                {
                    this.hlTranslate.Attributes.Add("onclick", Modal.ApplyTranslate.GetShowPopWinString(base.ProjectID));
                }
                if (this.hlComment != null)
                {
                    this.hlComment.Attributes.Add("onclick", Modal.ApplyComment.GetShowPopWinString(base.ProjectID));
                }
        ...
        void rptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ltlLimit.Text = ApplyManager.GetDateLimit(base.ProjectInfo, applyInfo);
                ...
                ltlFlowUrl.Text = string.Format(@"<a href=""javascript:;"" onclick=""{0}"">轨迹</a>", Modal.ApplyFlow.GetShowPopWinString(base.ProjectID, applyInfo.ID));
                ltlViewUrl.Text = string.Format(@"<a href=""javascript:;"" onclick=""{0}"">查看</a>", Modal.ApplyView.GetShowPopWinString(base.ProjectID, applyInfo.ID));
            }
        }
