...
{
    public class BackgroundContact : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!IsPostBack)
            {
                ...
                EBooleanUtils.AddListItems(this.ddlTaxis, "µ¹Ðò", "ÕýÐò");
        ...
        void rptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ltlEditUrl.Text = string.Format(@"<a href=""{0}"">±à¼­</a>", BackgroundContactAdd.GetEditUrl(contactInfo.ID, this.PageUrl));
            }
        }
        ...
        protected string PageUrl
        {
            get
            {
                ...
                {
                    _pageUrl = BackgroundContact.GetRedirectUrl(TranslateUtils.ToBool(this.ddlTaxis.SelectedValue), this.tbKeyword.Text, TranslateUtils.ToInt(Request.QueryString["page"], 1));
                }
                return _pageUrl;
            }
        }
        ...
        {
            return string.Format("background_contact.aspx?isTaxisDESC={0}&keyword={1}&page={2}", isTaxisDESC, keyword, page);
        }
    }
}
