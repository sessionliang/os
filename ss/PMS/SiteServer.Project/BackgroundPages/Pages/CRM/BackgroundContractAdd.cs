...
namespace SiteServer.Project.BackgroundPages
{
    public class BackgroundContractAdd : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (this.contractInfo != null)
            {
                base.AddAttributes(this.contractInfo);
        ...
        public override void Submit_OnClick(object sender, System.EventArgs e)
        {
            try
            {
                if (this.contractInfo != null)
                {
                    ContractInfo contractInfoToEdit = DataProvider.ContractDAO.GetContractInfo(base.Request.Form);
                    foreach (string attributeName in ContractAttribute.BasicAttributes)
                    {
                        if (base.Request.Form[attributeName] != null)
                        {
                            this.contractInfo.SetExtendedAttribute(attributeName, contractInfoToEdit.GetExtendedAttribute(attributeName));
                        }
                    }
                ...
                {
                    ContractInfo contractInfoToAdd = DataProvider.ContractDAO.GetContractInfo(base.Request.Form);
