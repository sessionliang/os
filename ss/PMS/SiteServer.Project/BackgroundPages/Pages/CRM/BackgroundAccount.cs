...
{
    public class BackgroundAccount : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            if (!string.IsNullOrEmpty(base.Request.QueryString["Delete"]))
            {
                ...
                if (arraylist.Count > 0)
                {
                    try
                    {
                        DataProvider.AccountDAO.Delete(arraylist);
        ...
        void rptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Literal ltlContract = e.Item.FindControl("ltlContract") as Literal;
                ...
                ltlAccountType.Text = EAccountTypeUtils.GetText(accountInfo.AccountType);
                ...
                ltlContract.Text = string.Format(@"<a href=""{0}""><i class=""icon-plus""></i></a>", BackgroundContractAdd.GetAddUrlToSiteServer(accountInfo.ID, this.PageUrl));
        ...
        protected string GetSelectString()
        {
            ...
            {
                return DataProvider.AccountDAO.GetSelectString(AdminManager.Current.UserName, base.Request.QueryString["accountType"], base.Request.QueryString["keyword"]);
            }
            else
            {
                return DataProvider.AccountDAO.GetSelectString(AdminManager.Current.UserName);
            }
        }
        ...
        protected string PageUrl
        {
            get
            {
                ...
                {
                    _pageUrl = BackgroundAccount.GetRedirectUrl(TranslateUtils.ToBool(this.ddlTaxis.SelectedValue), this.ddlAccountType.SelectedValue, this.tbKeyword.Text, TranslateUtils.ToInt(Request.QueryString["page"], 1));
                }
                return _pageUrl;
            }
        }

        public static string GetRedirectUrl(bool isTaxisDESC, string accountType, string keyword, int page)
        {
            return string.Format("background_account.aspx?isTaxisDESC={0}&accountType={1}&keyword={2}&page={3}", isTaxisDESC, accountType, keyword, page);
        }
    }
}
