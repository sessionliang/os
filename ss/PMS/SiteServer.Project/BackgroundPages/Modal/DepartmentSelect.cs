...
namespace SiteServer.Project.BackgroundPages.Modal
{
	public class DepartmentSelect : BackgroundBasePage
	{
        ...
        public static string GetShowPopWinString(int projectID)
        {
            ...
            return JsUtils.OpenWindow.GetOpenWindowString("…Ë÷√∑÷¿‡", "modal_departmentSelect.aspx", arguments, 460, 260, true);
        }

		public void Page_Load(object sender, EventArgs E)
		{
            this.additional.Add("UrlFormatString", string.Format("modal_departmentSelect.aspx?ProjectID={0}", base.ProjectID) + "&DepartmentID={0}");
