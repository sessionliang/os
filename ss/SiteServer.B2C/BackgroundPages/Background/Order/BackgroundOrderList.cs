...
{
    public class BackgroundOrderList : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!IsPostBack)
            {
                base.BreadCrumb(AppManager.B2C.LeftMenu.ID_Order, "订单列表", string.Empty);
        ...
        void rptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ltlUserName.Text = OrderManager.GetOrderUser(base.PublishmentSystemInfo.GroupSN, orderInfo.UserName);
                ...
                string urlDelete = PageUtils.AddQueryString(BackgroundOrderList.GetRedirectUrl(base.PublishmentSystemID, orderInfo.ID), "UpdateState", "True");
        ...
        protected string PageUrl
        {
            get
            {
                ...
                {
                    _pageUrl = BackgroundOrderList.GetRedirectUrl(base.PublishmentSystemID, this.ddlOrderStatus.SelectedValue, this.ddlPaymentStatus.SelectedValue, this.ddlShipmentStatus.SelectedValue, this.tbOrderSN.Text, this.tbKeyword.Text, TranslateUtils.ToInt(base.GetQueryString("page"), 1));
                }
                return _pageUrl;
            }
        }
        ...
        {
            return PageUtils.GetB2CUrl(string.Format("background_orderList.aspx?PublishmentSystemID={0}", publishmentSystemID));
        }

        public static string GetRedirectUrl(int publishmentSystemID, int orderID)
        {
            return PageUtils.GetB2CUrl(string.Format("background_orderList.aspx?PublishmentSystemID={0}&OrderID={1}", publishmentSystemID, orderID));
        }
        ...
        {
            return PageUtils.GetB2CUrl(string.Format("background_orderList.aspx?PublishmentSystemID={0}&orderStatus={1}&paymentStatus={2}&shipmentStatus={3}&orderSN={4}&keyword={5}&page={6}", publishmentSystemID, orderStatus, paymentStatus, shipmentStatus, orderSN, keyword, page));
        }
    }
}
