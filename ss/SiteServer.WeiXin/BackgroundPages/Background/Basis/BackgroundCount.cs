...
namespace SiteServer.WeiXin.BackgroundPages
{
    public class BackgroundCount : BackgroundBasePageWX
    {
        ...
        {
            base.BreadCrumb(AppManager.WeiXin.LeftMenu.ID_Accounts, AppManager.WeiXin.LeftMenu.Function.ID_Chart, string.Empty, AppManager.WeiXin.Permission.WebSite.Chart);
            ...
            for (; dateTime <= DateTime.Now; dateTime = dateTime.AddMonths(1))
            {
                ...
                int amountPaid = DataProviderWX.CountDAO.GetCount(base.PublishmentSystemID, dateTime.Year, dateTime.Month, ECountType.UserSubscribe);

                StringBuilder builder1 = new StringBuilder();
                StringBuilder builder2 = new StringBuilder();
                Dictionary<int, int> dictionary = DataProviderWX.CountDAO.GetDayCount(base.PublishmentSystemID, dateTime.Year, dateTime.Month, ECountType.UserSubscribe);
