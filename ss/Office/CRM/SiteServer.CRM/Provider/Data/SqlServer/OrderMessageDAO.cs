...
namespace SiteServer.CRM.Provider.Data.SqlServer
{
    public class OrderMessageDAO : DataProviderBase, IOrderMessageDAO
	{
        ...
        public int Insert(OrderMessageInfo messageInfo)
        {
            ...
            string SQL_INSERT = BaiRongDataProvider.TableStructureDAO.GetInsertSqlString(messageInfo.ToNameValueCollection(), TABLE_NAME, out parms);
        ...
        {
            IDbDataParameter[] parms = null;
            string SQL_UPDATE = BaiRongDataProvider.TableStructureDAO.GetUpdateSqlString(messageInfo.ToNameValueCollection(), TABLE_NAME, out parms);
