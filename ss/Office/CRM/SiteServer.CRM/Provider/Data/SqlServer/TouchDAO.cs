...
namespace SiteServer.CRM.Provider.Data.SqlServer
{
    public class TouchDAO : DataProviderBase, ITouchDAO
    {
        ...
        public int Insert(TouchInfo touchInfo)
        {
            ...
            string SQL_INSERT = BaiRongDataProvider.TableStructureDAO.GetInsertSqlString(touchInfo.ToNameValueCollection(), TABLE_NAME, out parms);
        ...
        {
            IDbDataParameter[] parms = null;
            string SQL_UPDATE = BaiRongDataProvider.TableStructureDAO.GetUpdateSqlString(touchInfo.ToNameValueCollection(), TABLE_NAME, out parms);
        ...
        public bool IsMessageIDExists(int leadID, int orderID, int messageID)
        {
            ...
            string SQL_SELECT = BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(TABLE_NAME, 0, TouchAttribute.ID, SQL_WHERE, null);
        ...
        public List<TouchInfo> GetTouchInfoList(int leadID, int orderID)
        {
            ...
            if (leadID > 0 || orderID > 0)
            {
                ...
                string SQL_SELECT = BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(TABLE_NAME, 0, SqlUtils.Asterisk, SQL_WHERE, "ORDER BY ID DESC");
