...
namespace SiteServer.CRM.Provider.Data.SqlServer
{
    public class FormPageDAO : DataProviderBase, IFormPageDAO
	{
        public int Insert(FormPageInfo formPageInfo)
        {
            ...
            string SQL_INSERT = BaiRongDataProvider.TableStructureDAO.GetInsertSqlString(formPageInfo.Attributes, FormPageInfo.TableName, out parms);
        ...
        public void Update(FormPageInfo formPageInfo)
        {
            formPageInfo.BeforeExecuteNonQuery();
            IDbDataParameter[] parms = null;
            string SQL_UPDATE = BaiRongDataProvider.TableStructureDAO.GetUpdateSqlString(formPageInfo.Attributes, FormPageInfo.TableName, out parms);
        ...
        public FormPageInfo GetFormPageInfo(int formPageID)
        {
            ...
            string SQL_SELECT = BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(FormPageInfo.TableName, 0, SqlUtils.Asterisk, SQL_WHERE, null);
        ...
        {
            IEnumerable enumerable = (IEnumerable)this.ExecuteReader(this.GetSelectString(mobanID));
            return enumerable;
        }

        public string GetSelectString(int mobanID)
        {
            return BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(FormPageInfo.TableName, 0, SqlUtils.Asterisk, string.Format("MobanID = {0}", mobanID), this.GetOrderByString());
        }
