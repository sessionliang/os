...
namespace SiteServer.CRM.Provider.Data.SqlServer
{
    public class OrderRefundDAO : DataProviderBase, IOrderRefundDAO
	{
        public int Insert(OrderRefundInfo refundInfo)
        {
            ...
            string SQL_INSERT = BaiRongDataProvider.TableStructureDAO.GetInsertSqlString(refundInfo.Attributes, OrderRefundInfo.TableName, out parms);
        ...
        public void Update(OrderRefundInfo refundInfo)
        {
            refundInfo.BeforeExecuteNonQuery();
            IDbDataParameter[] parms = null;
            string SQL_UPDATE = BaiRongDataProvider.TableStructureDAO.GetUpdateSqlString(refundInfo.Attributes, OrderRefundInfo.TableName, out parms);
        ...
        public OrderRefundInfo GetOrderRefundInfo(int refundID)
        {
            ...
            string SQL_SELECT = BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(OrderRefundInfo.TableName, 0, SqlUtils.Asterisk, SQL_WHERE, null);
        ...
        {
            return BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(OrderRefundInfo.TableName, 0, SqlUtils.Asterisk, null, null);
        }
        ...
        public string GetSelectString(string keyword)
        {
            ...
            return BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(OrderRefundInfo.TableName, 0, SqlUtils.Asterisk, whereString, null);
        }
