...
namespace SiteServer.CRM.Provider.Data.SqlServer
{
    public class FormGroupDAO : DataProviderBase, IFormGroupDAO
    {
        public int Insert(FormGroupInfo formGroupInfo)
        {
            ...
            string SQL_INSERT = BaiRongDataProvider.TableStructureDAO.GetInsertSqlString(formGroupInfo.Attributes, FormGroupInfo.TableName, out parms);
        ...
        public void Update(FormGroupInfo formGroupInfo)
        {
            formGroupInfo.BeforeExecuteNonQuery();
            IDbDataParameter[] parms = null;
            string SQL_UPDATE = BaiRongDataProvider.TableStructureDAO.GetUpdateSqlString(formGroupInfo.Attributes, FormGroupInfo.TableName, out parms);
        ...
        public FormGroupInfo GetFormGroupInfo(int formGroupID)
        {
            ...
            string SQL_SELECT = BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(FormGroupInfo.TableName, 0, SqlUtils.Asterisk, SQL_WHERE, null);
        ...
        public List<FormGroupInfo> GetFormGroupInfoList(int pageID)
        {
            ...
            string SQL_SELECT = BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(FormGroupInfo.TableName, 0, SqlUtils.Asterisk, SQL_WHERE, this.GetOrderByString());
        ...
        {
            IEnumerable enumerable = (IEnumerable)this.ExecuteReader(this.GetSelectString(pageID));
            return enumerable;
        }

        public string GetSelectString(int pageID)
        {
            return BaiRongDataProvider.TableStructureDAO.GetSelectSqlString(FormGroupInfo.TableName, 0, SqlUtils.Asterisk, string.Format("PageID = {0}", pageID), this.GetOrderByString());
        }
