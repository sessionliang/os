...
namespace SiteServer.CRM.BackgroundPages.Modal
{
	public class AccountSelect : BackgroundBasePage
	{
        ...
        public static string GetShowPopWinString(int publishmentSystemID, string scriptName, bool isAllAccount)
        {
            NameValueCollection arguments = new NameValueCollection();
            arguments.Add("publishmentSystemID", publishmentSystemID.ToString());
            arguments.Add("scriptName", scriptName);
            arguments.Add("isAllAccount", isAllAccount.ToString());
            return JsUtils.OpenWindow.GetOpenWindowString("选择客户", PageUtils.GetCRMUrl("modal_accountSelect.aspx"), arguments, true);
        }
