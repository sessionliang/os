...
{
    public class BackgroundDocumentAll : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!IsPostBack)
            {
                this.dgContents.DataSource = DataProvider.DocumentDAO.GetDataSource();
        ...
        void dgContents_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    ltlDeleteUrl.Text = string.Format(@"<a href=""background_documentAll.aspx?Delete=True&DocumentID={0}"" onClick=""javascript:return confirm('此操作将删除文档“{1}”，确认吗？');"">删除</a>", documentID, fileName);
                }
            }
        }
    }
