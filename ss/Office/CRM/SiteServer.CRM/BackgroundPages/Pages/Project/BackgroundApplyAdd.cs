...
namespace SiteServer.CRM.BackgroundPages
{
    public class BackgroundApplyAdd : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            {
                this.returnUrl = BackgroundApplyToWork.GetRedirectUrl(base.PublishmentSystemID);
            }
        ...
        public override void Submit_OnClick(object sender, System.EventArgs e)
        {
            try
            {
                ApplyInfo applyInfo = new ApplyInfo(0, base.PublishmentSystemID, TranslateUtils.ToInt(this.ddlPriority.SelectedValue), TranslateUtils.ToInt(this.ddlTypeID.SelectedValue), AdminManager.Current.UserName, DateTime.Now, string.Empty, DateTime.Now, string.Empty, DateTime.Now, 0, string.Empty, 0, EApplyState.New, this.tbTitle.Text);
