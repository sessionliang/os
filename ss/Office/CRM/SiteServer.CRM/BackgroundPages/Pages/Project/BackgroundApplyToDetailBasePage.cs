...
namespace SiteServer.CRM.BackgroundPages
{
    public class BackgroundApplyToDetailBasePage : BackgroundBasePage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                this.ltlProjectName.Text = base.PublishmentSystemInfo.PublishmentSystemName;
                ...
                this.ltlDateLimit.Text = ApplyManager.GetDateLimit(base.PublishmentSystemInfo, applyInfo);
