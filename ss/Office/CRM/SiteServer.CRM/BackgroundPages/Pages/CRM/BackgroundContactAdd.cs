    ...
    public class BackgroundContactAdd : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (id > 0)
            {
                ...
                base.AddAttributes(this.contactInfo.ToNameValueCollection());
            ...
            if (!IsPostBack)
            {
                ...
                this.ltlAccountID.Text = string.Format(@"<div class=""btn_pencil"" onclick=""{0}""><span class=""pencil""></span>　选择</div>", Modal.AccountSelect.GetShowPopWinString(base.PublishmentSystemID, "selectAccountID", false));
                if (accountInfo != null)
                {
        ...
        public override void Submit_OnClick(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (this.contactInfo != null)
                {
                    ...
                    foreach (string attributeName in ContactAttribute.AllAttributes)
                    {
                        if (base.Request.Form[attributeName] != null)
                        {
                            this.contactInfo.SetValue(attributeName, contactInfoToEdit.GetValue(attributeName));
                        }
                    }
