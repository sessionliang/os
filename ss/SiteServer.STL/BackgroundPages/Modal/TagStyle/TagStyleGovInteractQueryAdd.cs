...
{
	public class TagStyleGovInteractQueryAdd : BackgroundBasePage
	{
        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
			...
			{
                ArrayList styleNameArrayList = DataProvider.TagStyleDAO.GetStyleNameArrayList(base.PublishmentSystemID, StlGovInteractQuery.ElementName);
