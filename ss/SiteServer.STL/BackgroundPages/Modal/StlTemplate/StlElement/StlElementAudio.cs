...
{
    public class StlElementAudio : BackgroundBasePage
    {
        ...
        public static string GetOpenLayerStringToEdit(int publishmentSystemID, int templateID, string includeUrl, int stlIndex, string stlEncryptElement)
        {
            ...
            return JsUtils.Layer.GetOpenLayerString("播放音频（stl:audio）编辑", PageUtils.GetSTLUrl("modal_stlElementAudio.aspx"), arguments);
        }
        ...
        public static string GetOpenLayerStringToAdd(int publishmentSystemID, int templateID, string includeUrl)
        {
            ...
            return JsUtils.Layer.GetOpenLayerString("播放音频（stl:audio）新增", PageUtils.GetSTLUrl("modal_stlElementAudio.aspx"), arguments);
        }
        ...
        public string UploadUrl
        {
            get
            {
                return PageUtils.GetSTLUrl(string.Format("modal_stlElementAudio.aspx?PublishmentSystemID={0}&upload=True", base.PublishmentSystemID));
            }
        }
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!string.IsNullOrEmpty(attributes[StlAudio.Attribute_PlayUrl]))
            {
                this.tbPlayUrl.Text = attributes[StlAudio.Attribute_PlayUrl];
            }
            if (!string.IsNullOrEmpty(attributes[StlAudio.Attribute_IsAutoPlay]))
            {
                this.cbIsAutoPlay.Checked = TranslateUtils.ToBool(attributes[StlAudio.Attribute_IsAutoPlay]);
            }
        ...
        private string GetStlElement()
        {
            ...
            if (base.Page.IsPostBack)
            {
                ...
                stlElement = StlParserUtility.GetStlElement(StlAudio.ElementName, attributes, null);
            }
            return stlElement;
        }
