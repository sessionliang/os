...
{
    public class ConsolePublishmentSystemReplace : BackgroundBasePage
	{
		...
		public void Page_Load(object sender, EventArgs E)
        {
			...
			if (!IsPostBack)
            {
                base.BreadCrumbConsole(AppManager.CMS.LeftMenu.ID_Site, "整站替换", AppManager.Platform.Permission.Platform_Site);
                ...
                {
                    PageUtils.RedirectToErrorPage("无应用模板！");
                }
			}
		}
		...
		public void NextPlaceHolder(Object sender, EventArgs e)
		{
		    switch (CurrentWizardPlaceHolder)
			{
                ...
                case WizardPlaceHolder.CreateSiteParameters:
                    ...
                    LogUtils.AddLog(BaiRongDataProvider.AdministratorDAO.UserName, "整站替换", string.Format("应用:{0}", base.PublishmentSystemInfo.PublishmentSystemName));
