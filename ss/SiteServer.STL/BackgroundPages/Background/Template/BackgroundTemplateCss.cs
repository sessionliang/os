...
{
	public class BackgroundTemplateCss : BackgroundBasePage
	{
		...
		public void Page_Load(object sender, EventArgs E)
        {
			...
			if (!base.IsPostBack)
            {
                base.BreadCrumb(AppManager.CMS.LeftMenu.ID_Template, "样式文件管理", AppManager.CMS.Permission.WebSite.Template);
				...
				if (base.GetQueryString("Delete") != null)
				{
					...
					try
					{
                        ...
                        StringUtility.AddLog(base.PublishmentSystemID, "删除样式文件", string.Format("样式文件:{0}", fileName));
