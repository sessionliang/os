...
{
    public class BackgroundWebsiteMessageTemplateEmail : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!IsPostBack)
            {
                base.BreadCrumb(AppManager.CMS.LeftMenu.ID_Function, AppManager.CMS.LeftMenu.Function.ID_WebsiteMessage, "邮件回复模板", AppManager.CMS.Permission.WebSite.WebsiteMessage);
                ...
                {
                    this.Title.Text = this.websiteMessageInfo.Additional.MailTitle;
                    this.Content.Text = this.websiteMessageInfo.Additional.MailContent;
                }
                else
                {
        ...
        public void IsCreateTemplate_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.Content.Text = websiteMessageTemplate.GetEmailContentReply(tableStyleInfoArrayList);
            this.Title.Text = websiteMessageTemplate.GetEmailTitleReply();
        }
        ...
        public override void Submit_OnClick(object sender, EventArgs E)
        {
            if (base.Page.IsPostBack && base.Page.IsValid)
            {
                ...
                this.websiteMessageInfo.Additional.MailTitle = this.Title.Text;
                this.websiteMessageInfo.Additional.MailContent = this.Content.Text;
