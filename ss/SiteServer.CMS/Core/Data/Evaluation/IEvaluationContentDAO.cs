...
{
    public interface IEvaluationContentDAO
    {
        string TableName
        {
            get;
        ...
        int Insert(EvaluationContentInfo info);
        ...
        List<EvaluationContentInfo> GetInfoListChecked(int publishmentSystemID, int nodeID, int contentID);
        ...
        EvaluationContentInfo GetInfo(int publishmentSystemID, int nodeID, int contentID, int id);
