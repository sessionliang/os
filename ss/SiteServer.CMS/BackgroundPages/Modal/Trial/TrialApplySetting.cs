...
{
    public class TrialApplySetting : BackgroundBasePage
    {
        ...
        public static string GetOpenWindowString(int publishmentSystemID, int nodeID, string returnUrl)
        {
            ...
            return PageUtility.GetOpenWindowStringWithCheckBoxValue("试用设置", "modal_trialApplySetting.aspx", arguments, "ContentIDCollection", "请选择需要设置试用选项的内容！", 360, 350);
        }
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (this.contentIDs.Count == 1)
                {
                    ...
                    this.tbBeginDate.Text = attributes[ContentAttribute.Trial_BeginDate];
                    this.tbEndDate.Text = attributes[ContentAttribute.Trial_EndDate];
                }
            }
        }
        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
            ...
            foreach (ContentInfo info in list)
            {
                ...
                NameValueCollection attributes = TranslateUtils.ToNameValueCollection(settingsXML);
                attributes[ContentAttribute.Trial_BeginDate] = this.tbBeginDate.Text;
                attributes[ContentAttribute.Trial_EndDate] = this.tbEndDate.Text;
            ...
            StringUtility.AddLog(base.PublishmentSystemID, "试用设置", string.Format("内容:{0}", TranslateUtils.ObjectCollectionToSqlInStringWithoutQuote(titles)));
