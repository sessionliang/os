...
{
    public class WebsiteMessageClassifyAdd : BackgroundBasePage
    {
        public HtmlControl divSelectWebsiteMessageClassify;
        public Literal ltlSelectWebsiteMessageClassifyScript;
        ...
        public static string GetOpenWindowString(int publishmentSystemID, int itemID, string returnUrl)
        {
            ...
            return PageUtility.GetOpenWindowString("添加分类", "modal_websiteMessageClassifyAdd.aspx", arguments);
        }
        ...
        public static string GetRedirectUrl(int publishmentSystemID, int itemID, string returnUrl)
        {
            ...
            arguments.Add("ItemID", itemID.ToString());
            arguments.Add("ReturnUrl", StringUtils.ValueToUrl(returnUrl));
            return PageUtils.AddQueryString(PageUtils.GetCMSUrl("modal_websiteMessageClassifyAdd.aspx"), arguments);
        }
                    ...
                    if (!string.IsNullOrEmpty(item))
                    {
                        ...
                        if (!string.IsNullOrEmpty(itemName) && insertedItemIDHashtable.Contains(count))
                        {
                            ...
                            if (!string.IsNullOrEmpty(itemIndex))
                            {
                                ...
                                {
                                    itemIndexNameList = DataProvider.WebsiteMessageClassifyDAO.GetItemIndexNameArrayList(base.PublishmentSystemID);
                                }
                            ...
                            int insertedItemID = DataProvider.WebsiteMessageClassifyDAO.InsertWebsiteMessageClassifyInfo(base.PublishmentSystemID, parentID, itemName, itemIndex);
        ...
        public void ParentItemID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PageUtils.Redirect(WebsiteMessageClassifyAdd.GetRedirectUrl(base.PublishmentSystemID, theItemID, base.GetQueryString("ReturnUrl")));
        }
    }
}
