...
namespace SiteServer.CMS.BackgroundPages.Modal
{
	public class UserTableMetadataView : BackgroundBasePage
	{
        ...
        public static string GetOpenWindowString(int publishmentSystemID, string attributeName)
        {
            ...
            return PageUtility.GetOpenWindowString("用户字段查看", "modal_userTableMetadataView.aspx", arguments, 480, 410, true);
        }
		...
		public void Page_Load(object sender, EventArgs E)
        {
			...
			if (!IsPostBack)
			{
                TableStyleInfo styleInfo = TableStyleManager.GetTableStyleInfo(ETableStyle.User, base.PublishmentSystemInfo.GroupSN, this.attributeName, null);
