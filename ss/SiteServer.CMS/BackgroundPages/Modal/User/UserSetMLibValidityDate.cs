...
namespace SiteServer.CMS.BackgroundPages.Modal
{
    ...
    public class UserSetMLibValidityDate : BackgroundBasePage
    {
        ...
        public static string GetOpenWindowString()
        {
            ...
            return PageUtilityPF.GetOpenWindowStringWithCheckBoxValue("设置用户投稿有效期", "modal_userNewGroupSetMLibValidityDate.aspx", arguments, "UserIDCollection", "请选择需要设置投稿有效期的用户！", 400, 220);
        }
