...
{
	public class BackgroundTrackerDay : BackgroundBasePage
	{
		...
		public string GetGraphicHtml(int index)
		{
            ...
            string html = string.Format("<IMG title=访问量：{0} height={1} style=height:{1}px src=../pic/tracker_bar.gif width=16><BR>{2}", accessNum, height, datetime.Day);
			return html;
		}
		...
		public string GetUniqueGraphicHtml(int index)
		{
            ...
            string html = string.Format("<IMG title=访客数：{0} height={1} style=height:{1}px src=../pic/tracker_bar.gif width=16><BR>{2}", uniqueAccessNum, height, datetime.Day);
			return html;
		}
		...
		public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!IsPostBack)
            {
                base.BreadCrumb(AppManager.CMS.LeftMenu.ID_Function, AppManager.CMS.LeftMenu.Function.ID_Tracking, "天统计", AppManager.CMS.Permission.WebSite.Tracking);

                Hashtable trackingDayHashtable = DataProvider.TrackingDAO.GetTrackingDayHashtable(base.PublishmentSystemID);
                Hashtable uniqueTrackingDayHashtable = DataProvider.TrackingDAO.GetUniqueTrackingDayHashtable(base.PublishmentSystemID);
                ...
                for (int i = 0; i < 30; i++)
                {
                    ...
                    this.accessNumHashtable.Add(30 - i, accessNum);
                    ...
                    this.uniqueAccessNumHashtable.Add(30 - i, uniqueAccessNum);
                ...
                this.ExportTracking.Attributes.Add("onclick", PageUtility.ModalSTL.ExportMessage.GetOpenWindowStringToExport(base.PublishmentSystemID, PageUtility.ModalSTL.ExportMessage.EXPORT_TYPE_TrackerDay));
            }
		}
