...
namespace SiteServer.CMS.BackgroundPages
{
	public class BackgroundContentTranslate : BackgroundBasePage
	{
        ...
        {
            string redirectUrl = PageUtils.GetCMSUrl(string.Format("background_contentTranslate.aspx?PublishmentSystemID={0}&ReturnUrl={1}", publishmentSystemID, StringUtils.ValueToUrl(returnUrl)));
        ...
        {
            string redirectUrl = PageUtils.GetCMSUrl(string.Format("background_contentTranslate.aspx?PublishmentSystemID={0}&NodeID={1}&ReturnUrl={2}", publishmentSystemID, nodeID, StringUtils.ValueToUrl(returnUrl)));
                    ...
                    try
                    {
                        ...
                        foreach (int nodeID in this.idsHashtable.Keys)
                        {
                            ...
                            if (contentIDArrayList.Count > 0)
                            {
                                ...
                                ContentUtility.Translate(base.PublishmentSystemInfo, builder.ToString(), base.Request.Form["translateCollection"], translateType);
                            }
                        }
