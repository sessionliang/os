...
{
    public class BackgroundContentSearch : BackgroundBasePage
    {
        ...
        public void Page_Load(object sender, EventArgs E)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (AdminUtility.HasChannelPermissions(base.PublishmentSystemID, base.PublishmentSystemID, AppManager.CMS.Permission.Channel.ContentCheck))
                {
                    showPopWinString = Modal.ContentCheck.GetOpenWindowStringForMultiChannels(base.PublishmentSystemID, this.PageUrl);
        ...
        private string PageUrl
        {
            get
            {
                ...
                {
                    this._pageUrl = PageUtils.GetCMSUrl(string.Format("background_contentSearch.aspx?PublishmentSystemID={0}&NodeID={1}&State={2}&IsDuplicate={3}&SearchType={4}&Keyword={5}&DateFrom={6}&DateTo={7}", base.PublishmentSystemID, this.NodeIDDropDownList.SelectedValue, this.State.SelectedValue, this.IsDuplicate.Checked, this.SearchType.SelectedValue, this.Keyword.Text, this.DateFrom.Text, this.DateTo.Text));
                }
