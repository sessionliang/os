...
namespace SiteServer.CMS.Model
{
    public class SitePageInfo
    {
        ...
        {
            this.siteID = this.channelID = this.contentID = this.pageIndex = 0;
        }

        public static SitePageInfo GetInstance()
        {
            SitePageInfo pageInfo = new SitePageInfo();
            ...
            {
                string path = HttpContext.Current.Request.Path.Substring(0, HttpContext.Current.Request.Path.LastIndexOf(".aspx"));
