...
{
    public class WebsiteMessageInfoExtend : ExtendedAttributes
    {
        public WebsiteMessageInfoExtend(string settingsXML)
        {
        ...
        {
            get { return base.GetString("LoginUrl", string.Empty); }
            set { base.SetExtendedAttribute("LoginUrl", value.ToString()); }
        }
