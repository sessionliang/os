...
{
    public class TextEditorImportWord : SystemBasePage
    {
        ...
        public void Submit_OnClick(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(fileNames))
            {
                ...
                {
                    string filePath = WordUtils.GetWordFilePath(fileName);
                    string wordContent = WordUtils.Parse(this.PublishmentSystemID, filePath, this.cbIsClearFormat.Checked, this.cbIsFirstLineIndent.Checked, this.cbIsClearFontSize.Checked, this.cbIsClearFontFamily.Checked, this.cbIsClearImages.Checked);
                    /****获取编辑器中内容，解析@符号，添加了远程路径处理 20151103****/
                    wordContent = StringUtility.TextEditorContentDecode(wordContent, this.PublishmentSystemInfo, true);
