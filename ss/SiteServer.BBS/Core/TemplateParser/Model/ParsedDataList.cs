...
namespace SiteServer.BBS.Core.TemplateParser.Model
{
    ...
    public class ParsedDataList : DataList
	{
        ...
        public void AddAttribute(string attributeName, string attributeValue)
		{
			...
			{
				GridLines = ParserUtility.ToGridLines(attributeValue);
			}
			else if (attributeName.Equals("horizontalalign"))
			{
                HorizontalAlign = ParserUtility.ToHorizontalAlign(attributeValue);
			}
			...
			{
                RepeatDirection = ParserUtility.ToRepeatDirection(attributeValue);
			}
			else if (attributeName.Equals("repeatlayout"))
			{
                RepeatLayout = ParserUtility.ToRepeatLayout(attributeValue);
			}
