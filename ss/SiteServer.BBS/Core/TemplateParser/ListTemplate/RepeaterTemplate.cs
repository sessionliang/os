...
namespace SiteServer.BBS.Core.TemplateParser.ListTemplate
{
    public class RepeaterTemplate : ITemplate
	{
        ...
        public RepeaterTemplate(string templateString, string separatorRepeatTemplate, int separatorRepeat, PageInfo pageInfo, EContextType contextType, ContextInfo contextInfo)
		{
